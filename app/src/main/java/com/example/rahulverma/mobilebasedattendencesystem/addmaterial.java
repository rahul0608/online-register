...
public class addmaterial extends AppCompatActivity {
    public static final String UPLOAD_URL = "http://palaeozoological-ri.000webhostapp.com/PhotoUpload/upload.php";
    ...
    private void uploadImage() {
        class UploadImage extends AsyncTask<Bitmap, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(addmaterial.this, "Uploading...", null, true, true);
            }
